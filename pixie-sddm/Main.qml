...
Rectangle {
    ...
    property color extractedAccent: "#7AA2F7"
    ...
    Item {
        ...
        Rectangle {
            ...
            color: loginState.isError ? "#4B1F2B" : "1B1D2E"
            border.width: 1
            border.color: "#7AA2F7"
            opacity: 0.7
            radius: 32
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    color: (sessionClickArea.pressed || sessionPopup.opened) ? "2A2D4A" : "#222436"
                    radius: 18
                    border.width: 1
                    border.color: (sessionClickArea.pressed || sessionPopup.opened) ? container.extractedAccent : "2A2D4A"
                ...
                RoundButton {
                    ...
                    background: Rectangle {
                        ...
                        gradient: Gradient {
                            ...
                            GradientStop { position: 1.0; color: "#7AA2F7" }
                        }
                    }
    ...
    Popup {
        ...
        ListView {
            ...
            delegate: ItemDelegate {
                ...
                background: Rectangle {
                    color: isCurrent ? "#2A2D4A" : (hovered ? "#222436" : "transparent")
                    radius: 12
                    Rectangle {
                ...
                contentItem: RowLayout {
                    ...
                    Rectangle {
                        ...
                        color: isCurrent ? container.extractedAccent : "#2A2D4A"
                        radius: 14
                        Text {
                            anchors.centerIn: parent
                            text: {
